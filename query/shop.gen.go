...
func newShop(db *gorm.DB, opts ...gen.DOOption) shop {
	...
	_shop.ID = field.NewString(tableName, "id")
	_shop.GiftID = field.NewString(tableName, "gift_id")
	_shop.Count = field.NewInt64(tableName, "count")
...
type shop struct {
	...
	ALL    field.Asterisk
	ID     field.String // 商城id
	GiftID field.String // 礼物id
	Count  field.Int64  // 礼物数量
...
func (s *shop) updateTableName(table string) *shop {
	...
	s.GiftID = field.NewString(table, "gift_id")
	s.Count = field.NewInt64(table, "count")
