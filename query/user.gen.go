...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Career = field.NewString(tableName, "career")
	_user.Image = field.NewString(tableName, "image")
	_user.Coin = field.NewInt64(tableName, "coin")
	_user.Credit = field.NewInt64(tableName, "credit")
	_user.MapID = field.NewString(tableName, "map_id")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Career = field.NewString(table, "career")
	u.Image = field.NewString(table, "image")
	u.Coin = field.NewInt64(table, "coin")
	u.Credit = field.NewInt64(table, "credit")
	u.MapID = field.NewString(table, "map_id")
