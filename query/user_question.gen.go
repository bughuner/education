...
func newUserQuestion(db *gorm.DB, opts ...gen.DOOption) userQuestion {
	...
	_userQuestion.ID = field.NewString(tableName, "id")
	_userQuestion.UserID = field.NewString(tableName, "user_id")
	_userQuestion.QuestionID = field.NewString(tableName, "question_id")
...
func (u *userQuestion) updateTableName(table string) *userQuestion {
	...
	u.QuestionID = field.NewString(table, "question_id")
...
func (u userQuestionDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IUserQuestionDo {
